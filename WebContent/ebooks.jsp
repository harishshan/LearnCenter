...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1"
	charset="UTF-8" />
<title>Learn Center  |  EBooks</title>
</head>
<body>
						...
						<article class="col1">
							<div class="pad_left1">
								<div class="wrapper">
									<div class="wrapper">
									<%
										ArrayList<EBooksCategoryBean> categoryList=EBooksDao.getEBooksCategory();
										Iterator<EBooksCategoryBean> categoryIterator=categoryList.iterator();		
										while(categoryIterator.hasNext())
										{
											EBooksCategoryBean currentCategory=categoryIterator.next();
									%>
									<br/><br/>
									<strong>
										<label>
									...
									<%
											ArrayList<EBooksBean> booksList = EBooksDao.getEBooks(currentCategory.getId());
